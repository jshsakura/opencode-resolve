...
interface LoggerOptions {
  enabled: boolean;
  fileLevel: LogLevel;
  stderrLevel: LogLevel | null; // null = no stderr mirror
  path: string;
}

function readOptions(directory: string): LoggerOptions {
 ...
 */
export function createResolveLogger(directory: string): ResolveLogger {
