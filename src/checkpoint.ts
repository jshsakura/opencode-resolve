 ...
 */
export async function createRollbackCheckpoint(directory: string, kind: RollbackKind): Promise<Checkpoint> {
 ...
 */
export function restoreCommandFor(ref: string): string {
